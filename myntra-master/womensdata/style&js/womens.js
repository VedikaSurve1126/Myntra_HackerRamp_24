var womensData = [{
    ...
    wishList: "WISHLIST ♡",
    addToBag: "ADD TO BAG",
    buttonImageUrl: "https://i.imgur.com/OuA4U9l.jpeg",  
    buttonLabel: "TRY ON",
...
},
{
    ...
    wishList: "WISHLIST ♡",
    addToBag: "ADD TO BAG",
    buttonImageUrl: "hhttps://i.imgur.com/OuA4U9l.jpeg",  
    buttonLabel: "TRY ON",
},
{
...
womensData.map(function(element) {
    ...
    button.textContent = element.buttonLabel;
    
    button.addEventListener("click", function() {
        window.location.href = '/character/characte.html'; 
    });
    
    document.body.appendChild(button);
    
    contentBox.append(brand, para, mix, wishList, addToBag,button);
